Github repository Link(cloning link): https://github.com/VCCT-PROG7312-2025-G1/st10275468_PROG7312_POE_Part2_MunicipalApplication_ThomasK_Gr01.git

Part 2 Youtube Video Link: https://youtu.be/YciX87iWqGI
...
Features:
Local Events and Announcements - This displays all the events supported by the government in a visually appealing manner. It allows users to: View all events; View specific event details; search events by category, date and event name; Sort through events using various different sorting methods; View recommended events; and View community announcements
...
1. Clone the repository from Github
	Open the terminal and run "git clone https://github.com/VCCT-PROG7312-2025-G1/st10275468_PROG7312_POE_Part2_MunicipalApplication_ThomasK_Gr01.git"
